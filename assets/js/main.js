    ...
    testimonialData: [
      {
        ...
        content: "Their expertise is apparent in every step of the project. I’m thrilled with the outcome and would definitely work with them again! definitely work with them again",
        rating: 5
      },
      {
        name: "Theresa Webb",
        designation: "Ui/Ux Designer",
        image: "assets/images/testimonial/client-img-1.jpg",
        content: "They were communicative, attentive, and exceeded all project goals. The quality and attention to detail were top-notch. Five stars aren’t enough! Five stars aren’t enough.",
        rating: 5
      },
      {
        name: "Theresa Webb",
        ...
        image: "assets/images/testimonial/client-img-1.jpg",
        content: "Financial planners help people knowledge about to how toio invest and save the money the most of us efficient way ever. Many people all across in the of country use them help peopl and save",
        rating: 5
      },
      {
        name: "Theresa Webb",
        designation: "Ui/Ux Designer",
        image: "assets/images/testimonial/client-img-2.jpg",
        content: "They understood my vision immediately and brought it to life even better than I’d imagined. Professional, creative, and always on time – I couldn’t be happier with the results!",
        rating: 5
      }
    ],

    testimonialDynamic: function () {
      var $wrapper = $('#testimonial-wrapper-dynamic');
      if ($wrapper.length) {
        var html = '';
        this.testimonialData.forEach(function (item) {
          var stars = '';
          ...
          html += `
            <div class="swiper-slide">
              <div class="client-testimonial-card-wrap">
                <div class="client-card-head">
                  <div class="client-info">
                    ...
                    <div class="client-details">
                      <h3 class="client-title">${item.name}</h3>
                      <p class="client-para">${item.designation}</p>
                    </div>
                  </div>
                  <div class="tmp-star">
                    <ul>
                ...
                <p class="client-para">${item.content}</p>
                <div class="quat-logo">
